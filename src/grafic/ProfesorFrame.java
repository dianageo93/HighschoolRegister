...
/**
 * A frame that will be used to show the details of a student.
 * It extends the UserFrameEquiped and implements the IUserFrameActions. 
 *
 */
public class ProfesorFrame extends UserFrameEquiped implements IUserFrameActions {
	...
	private class CustomActionListener implements ActionListener {
		...
		private Profesor p = Centralizator.getInstance().getProfesori().get(getUsername());
